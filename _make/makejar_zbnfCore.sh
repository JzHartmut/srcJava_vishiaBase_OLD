...
export OUTPUTFILE_JAVAC="../../zbnfjax/zbnfCore.jar"
...
INPUT_JAVAC=""
INPUT_JAVAC="$INPUT_JAVAC ../org/vishia/zbnf/Zbnf2Xml.java"
INPUT_JAVAC="$INPUT_JAVAC ../org/vishia/zbnf/ZbnfJavaOutput.java"
export INPUT_JAVAC
