...
set OUTPUTFILE_JAVAC=..\..\zbnfjax\zbnfCore.jar
...
set INPUT_JAVAC=
set INPUT_JAVAC=%INPUT_JAVAC% ../org/vishia/zbnf/Zbnf2Xml.java
set INPUT_JAVAC=%INPUT_JAVAC% ../org/vishia/zbnf/ZbnfJavaOutput.java
