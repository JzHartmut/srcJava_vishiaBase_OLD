 ...
 *   Use {@link JzTcScript#addContentToSelectContainer(org.vishia.cmd.JzTcScript.AddSub2List)} to add the content.
...
public class CmdStore
{
   ...
   *   Use {@link JzTcScript#addContentToSelectContainer(org.vishia.cmd.JzTcScript.AddSub2List)} to add the content.
   *   The content of this class is now removed.
   * <li>2016-12-26 Hartmut new: {@link #addSubOfJZcmdClass(org.vishia.cmd.JzTcScript.JZcmdClass)}: now adds classes 
   ...
   * <li>2013-09-08 Hartmut chg: {@link #addSubOfJZcmdClass(org.vishia.cmd.JzTcScript.JZcmdClass, int)} now public
   *   because readCmdCfg(...) removed to {@link org.vishia.commander.FcmdExecuter}. It has dependencies
   *   to the Zbnf package {@link org.vishia.jzTc.JzTc} which is not visible in this component by standalone compilation.
   *   The problem is: The {@link JzTcScript} is visible here, but the used translator for the JZcmdScript needs ZBNF 
