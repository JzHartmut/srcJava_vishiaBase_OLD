 ...
 * This class contains the reference to the {@link JzTcExecuter.ExecuteLevel} where this variable is located
 * and a reference to the {@link JzTcScript.Filepath}. The last one contains all information about the
 ...
 * <br><br>
 */
public final class JzTcFilepath {
   ...
   *   instead this, therewith a {@link JzTcFileset#listFiles(List, JzTcFilepath, boolean, org.vishia.util.FilePath.FilePathEnvAccess)}
   ...
   *   {@link JzTcScript.Filepath}. Both are separated because the parts in JZcmdScript are set completely
   ...
   * <li>2013-03-10 Hartmut new: Replace wildcards: {@link #absfile(JzTcFilepath)} (TODO for some more access methods)
   ...
   */
  JzTcFilepath(JzTcExecuter.ExecuteLevel zgenlevel, FilePath filepath){
   ...
   * @param filepath given data
   */
  JzTcFilepath(JzTcExecuter.ExecuteLevel zgenlevel, String filepath){
    this.zgenlevel = zgenlevel;
   ...
   *  
   */
  JzTcFilepath(JzTcExecuter.ExecuteLevel zgenlevel, JzTcFilepath src, JzTcFilepath commonPath, JzTcFilepath accessPath) throws NoSuchFieldException {
    this.zgenlevel = zgenlevel;
  ...
  public CharSequence localfileReplwildcard(StringBuilder uRet, JzTcFilepath replWildc){ 
