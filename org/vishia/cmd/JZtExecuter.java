...
/**This class is the executer of JZcmd. The translated JZscript is contained in an instance of {@link JZtScript}. 
 * It can be executed with a given script:
 * <ul>
 * <li>{@link #execute(JZtScript, boolean, boolean, Appendable, String)} executes a given translated script.
 * <li>{@link #execSub(org.vishia.cmd.JZtScript.Subroutine, Map, boolean, Appendable, File)} executes one subroutine
 ...
 * <li>{@link #initialize(JZtScript, boolean, Map, String, boolean)} cleans the instance and generates all script variables.
 *   It prepares usage for {@link #execSub(org.vishia.cmd.JZtScript.Subroutine, Map, boolean, Appendable, File)}.
 * <li>{@link #reset()} cleans the instance. The scriptvariables will be generate 
 *   by first call of {@link #execute(JZtScript, boolean, boolean, Appendable, String)}
 * </ul>
 * To use the Java platform's {@link javax.script.CompiledScript} eval method start {@link JZtScript#eval(ScriptContext)}
 ...
 * for one after another call of {@link #execute(JZtScript, boolean, boolean, Appendable)}.
...
public class JZtExecuter {
   ...
   * <li>2016-12-27 Hartmut chg: {@link #execSub(org.vishia.cmd.JZtScript.Subroutine, List, boolean, Appendable, File)} now works 
   ...
   *   The {@link #execSub(org.vishia.cmd.JZtScript.Subroutine, Map, boolean, Appendable, File)} 
   *   with Map supports a Variable Map, but it is not necessary for example for the.File:commander execution. 
   *   The {@link ExecuteLevel#levelForSubroutine(org.vishia.cmd.JZtScript.Subroutine)} now 
   ...
   *   <ul><li>Create a codeBlock variable with {@link ExecuteLevel#exec_DefCodeblockVariable(Map, org.vishia.cmd.JZtScript.Subroutine, boolean) on statement <code>Subtext name = ...</code>,
   *   <li>Create a codeBlock content in {@link ExecuteLevel#exec_DefList(org.vishia.cmd.JZtScript.DefContainerVariable, Map)} on {@link Subroutine} as content
   *   <li>execute the codeBlock in {@link ExecuteLevel#exec_Call(org.vishia.cmd.JZtScript.CallStatement, List, StringFormatter, int, int)} on found codeBlock variable as name
   *   <li>execute the codeBlock in  {@link ExecuteLevel#exec_Datatext(org.vishia.cmd.JZtScript.DataText, StringFormatter, int, int)} on found codeBlock variable (type 'X') with local given variables.
   ...
   * <li>2016-01-10 Hartmut chg: {@link #execSub(org.vishia.cmd.JZtScript.Subroutine, Map, boolean, Appendable, File)} now returns the "return" Map, not the localVariables. This is a more consequent concept.
   *   To assemble some user Parameter use {@link #execute_Scriptclass(org.vishia.cmd.JZtScript.JZcmdClass)}, whereby a class can define some variables. 
   * <li>2016-01-09 Hartmut {@link ExecuteLevel#exec_Call(org.vishia.cmd.JZtScript.CallStatement, List, StringFormatter, int, int)} Execution of a <:subtext:&var> which contains a Subtext is prepared, 
   *   but the maybe better variant is only <&var> and detection, it is a subtext.
   * <li>2016-01-09 Hartmut 'e': {@link ExecuteLevel#exec_Datatext(org.vishia.cmd.JZtScript.DataText, StringFormatter, int, int)} Execution of a Subtext variable which's statements are evaluated in the given environment.
   * <li>2016-01-09 Hartmut 'L': {@link ExecuteLevel#exec_DefList(org.vishia.cmd.JZtScript.DefContainerVariable, Map)}: Execution of a List, it is filled on creation of a list variable with content which is evaluated in the given environment.
   * <li>2016-01-06 Hartmut functionality enhancing: {@link #execSub(org.vishia.cmd.JZtScript.Subroutine, Map, boolean, Appendable, File)} now returns all variable of the subroutine level.
   * <li>2016-01-06 Hartmut functionality enhancing: {@link #execSub(org.vishia.cmd.JZtScript.Subroutine, Map, boolean, Appendable, File)} can work on the script level variables.
   ...
   *   by <+:create>newFile<.+>. Fix:  System.out is used for the text output via the argument out for {@link #execute(JZtScript, boolean, boolean, Appendable, String)}.
   ...
   *   It is checked now.
   * <li>2015-08-30 Hartmut new: flush an output in {@link ExecuteLevel#exec_TextAppendToVar(org.vishia.cmd.JZtScript.TextOut, int)}.
   * <li>2015-07-18 Hartmut chg: In {@link #execSub(org.vishia.cmd.JZtScript.Subroutine, Map, boolean, Appendable, File)}: 
   ...
   * <li>2015-06-04 Hartmut bugfix and improve: in {@link ExecuteLevel#exec_Text(org.vishia.cmd.JZtScript.JZcmditem, Appendable, int)}:
   ...
   *   is related to the {@link JZtExecuter.ExecuteLevel#currdir()}. 
   ...
   * <li>2015-05-10 Hartmut chg: {@link #execSub(org.vishia.cmd.JZtScript.Subroutine, Map, boolean, Appendable, File)}
   *   uses the argumet out as textout for <code><+>text output<.+></code> now. It is adequate like 
   *   {@link #execute(JZtScript, boolean, boolean, Appendable, String)} 
   ...
   * <li>2014-12-12 Hartmut new: If a subroutine's argument has the type 'F': {@link JZtFilepath}, then the argument is converted into this type if necessary.
   ...
   * <li>2014-10-20 Hartmut chg: break in a condition should break a loop, forwarding {@link #kBreak} from execution level in {@link ExecuteLevel#exec_IfStatement(org.vishia.cmd.JZtScript.IfStatement, StringFormatter, int, int)}.
   * <li>2014-10-20 Hartmut new: Map name = { String variable = "value"; Obj next; } now works. Changed 'M' instead 'X' in {@link JZtScript.JZcmditem#add_dataStruct(org.vishia.cmd.JZtScript.StatementList)}.
   *   {@link ExecuteLevel#evalObject(org.vishia.cmd.JZtScript.JZcmditem, boolean)} has accepted such dataStruct already (used in argumentlist), now with 'M' instead 'X'.
   *   {@link ExecuteLevel#exec_DefMapVariable(org.vishia.cmd.JZtScript.DefVariable, Map)} newly.  
   * <li>2014-10-20 Hartmut bufgix: some parameter in call of {@link ExecuteLevel#execute(org.vishia.cmd.JZtScript.StatementList, StringFormatter, int, boolean, Map, int)}
   ...
   * <li>2014-07-27 Hartmut bugfix: {@link ExecuteLevel#exec_hasNext(org.vishia.cmd.JZtScript.JZcmditem, StringFormatter, int, boolean, int)}
   * <li>2014-07-27 Hartmut chg: save one level for recursive execution, less stack, better able to view
   *   by calling {@link ExecuteLevel#execute(org.vishia.cmd.JZtScript.StatementList, StringFormatter, int, boolean, Map, int)}immediately.
   * <li>2014-06-15 Hartmut chg: improved {@link ExecuteLevel#exec_zmake(org.vishia.cmd.JZtScript.Zmake, StringFormatter, int, int)}:
   *   works with a Filepath for output.
   * <li>2014-06-15 Hartmut chg: improved {@link ExecuteLevel#exec_Copy(org.vishia.cmd.JZtScript.CallStatement)}:
   ...
   *   therewith a {@link JZtFileset#listFiles(List, JZtFilepath, boolean, org.vishia.util.FilePath.FilePathEnvAccess)}
   ...
   * <li>2014-06-01 Hartmut chg: {@link #genScriptVariables(JZtScript, boolean, Map, CharSequence)} and
   *   {@link #initialize(JZtScript, boolean, Map, String, boolean)} throws on any error.
   ...
   *   {@link ExecuteLevel#execute(org.vishia.cmd.JZtScript.StatementList, StringFormatter, int, boolean, Map, int)}
   ...
   * <li>2014-05-18 Hartmut chg: {@link ExecuteLevel#exec_Subroutine(org.vishia.cmd.JZtScript.Subroutine, Map, StringFormatter, int)}
   ...
   * <li>2014-05-10 Hartmut new: File: supported as conversion with currdir. See {@link JZtScript.JZcmdDataAccess#filepath}.
   ...
   * <li>2014-04-24 Hartmut chg: {@link #execute(JZtScript, boolean, boolean, Appendable, String)} 
   ...
   * <li>2014-03-01 Hartmut new: {@link ExecuteLevel#execForContainer(org.vishia.cmd.JZtScript.ForStatement, Appendable, int)}
   ...
   * <li>2014-02-16 Hartmut chg: Build of script variable currdir, scriptfile, scriptdir with them in {@link JZtExecuter#genScriptVariables(JZtScript, boolean, Map, CharSequence)}.
   *   {@link #execute(JZtScript, boolean, boolean, Appendable, String)} and {@link #execSub(org.vishia.cmd.JZtScript.Subroutine, Map, boolean, Appendable, File)}
   *   with sCurrDir.
   * <li>2014-02-01 Hartmut new: onerror errorlevel for cmd now works as statement. {@link ExecuteLevel#cmdErrorlevel}. 
   * <li>2014-02-01 Hartmut chg: now {@link ExecuteLevel#execute(org.vishia.cmd.JZtScript.StatementList, Appendable, int, boolean)}
  ...
  {
    final JZtExecuter jzCmdExecuter;
    ...
    private JZtScript jzcmdScript;
    
    Queue<CmdExecuter> runningCmdExecuter = new ConcurrentLinkedQueue<CmdExecuter>();
    
    
    public final Queue<JZtThread> threads = new ConcurrentLinkedQueue<JZtThread>();
    
    public final JZtThread scriptThread;

    
    public final ExecuteLevel scriptLevel;

    JZcmdMain(MainCmdLogging_ifc log, JZtExecuter jzCmdExecuter){
      this.log = log;
      this.jzCmdExecuter = jzCmdExecuter;
      scriptThread = new JZtThread();
  ...
  /**This is an instance used as marker for {@link #execSub(org.vishia.cmd.JZtScript.Subroutine, Map, boolean, Appendable, File)}
   ...
   */
  public JZtExecuter(MainCmdLogging_ifc log){
 ...
 * and then {@link #execute(JZtScript, boolean, boolean, Appendable)} with maybe several scripts,
 * which should not contain script variables, or one should call 
 * {@link #execSub(org.vishia.cmd.JZtScript.Subroutine, Map, boolean, Appendable)}
...
{ 
  ...
  try{
    ...
    if(scriptLevel.localVariables.get("test") == null) {DataAccess.createOrReplaceVariable(scriptLevel.localVariables, "test", 'O', new JZtTester(), true); }
 ...
 * The {@link #initialize(JZtScript, boolean, Map, CharSequence)} may had invoked before, then the standard variables are created already.
 * Any additional user variable can be stored also. If the {@link ExecuteLevel#localVariables} are empty, 
 * then {@link #initialize(JZtScript, boolean, Map, CharSequence)} is called with the script instead.
 * <br><br>
 * This method should be used. For example the script level can be used to {@link #execSub(org.vishia.cmd.JZtScript.Subroutine, Map, boolean, Appendable, File)}
 * for a sub routine which does not use script level variables, for example to set parameter.
 * Note: The standard script variables are set with {@link #initialize(JZtScript, boolean, Map, String, boolean)} already.
 * 
 * @param script The given script
 * @throws ScriptException
 */
public void  executeScriptLevel(JZtScript script, CharSequence sCurrdir) throws ScriptException //, IllegalAccessException
...
{
  JZtScript.JZcmdClass clazz1 = acc.jzcmdScript.getClass(sClazz);
 ...
 * @throws ScriptException
 */
public ExecuteLevel execute_Scriptclass(JZtScript.JZcmdClass clazz) throws ScriptException 
{
   ...
   * They are filled with the given script on call of {@link #initialize(JZtScript, boolean, Map, String, boolean)}
   * or if {@link #execute(JZtScript, boolean, boolean, Appendable, String)} was called.
   */
  ...
  private boolean checkInitialize(JZtScript script, boolean accessPrivate, Map<String, DataAccess.Variable<Object>> args, CharSequence sCurrdir) 
  ...
  private boolean checkInitialize(JZtScript script, boolean accessPrivate, List< DataAccess.Variable<Object>> args, CharSequence sCurrdir) 
  throws ScriptException //Throwable
  { boolean bscriptInitialized = script !=null && acc.jzcmdScript != script; //another script given.
    if(bscriptInitialized){
      initialize(script, accessPrivate, args, sCurrdir);
  ...
  private boolean checkInitialize(JZtScript script, boolean accessPrivate, CharSequence sCurrdir) 
  throws ScriptException //Throwable
  { boolean bscriptInitialized = script !=null && acc.jzcmdScript != script; //another script given.
    if(bscriptInitialized){
  ...
  private boolean checkInitialize(JZtScript script, boolean accessPrivate, Map<String, DataAccess.Variable<Object>> args, File currdir) 
    throws ScriptException //Throwable
  ...
  /**Executes the given script. See {@link #execute(JZtScript, boolean, boolean, Appendable, String)}
  ...
  {  
    ...
    JZtScript.Subroutine mainRoutine = acc.jzcmdScript.getMain();
  ...
  /**Executes a subroutine. See {@link #execSub(org.vishia.cmd.JZtScript.Subroutine, List, boolean, Appendable, File, CmdExecuter)}.
   ...
   * will be newly used. {@link #initialize(JZtScript, boolean, CharSequence)} will be invoked then.
   * @param args given as Map. It is converted to a list firstly. 
   */
  public Map<String, DataAccess.Variable<Object>> execSub(JZtScript script, String name, Map<String, DataAccess.Variable<Object>> args
    , boolean accessPrivate, Appendable out, File currdir) 
  throws ScriptException //Throwable
  { checkInitialize(script, true, null, currdir);
    JZtScript.Subroutine statement = acc.jzcmdScript.getSubroutine(name);
  ...
  /**Executes a subroutine. It invokes {@link #execSub(org.vishia.cmd.JZtScript.Subroutine, List, boolean, Appendable, File, CmdExecuter)}
   ...
   * @param args given as Map. It is converted to a list firstly. 
   */
  public Map<String, DataAccess.Variable<Object>> execSub(JZtScript script, String name, List<DataAccess.Variable<Object>> args
    , boolean accessPrivate, Appendable out, File currdir) 
  throws ScriptException //Throwable
  { checkInitialize(script, true, null, currdir);
    JZtScript.Subroutine statement = acc.jzcmdScript.getSubroutine(name);
   ...
   * @param args given as Map. It is converted to a list firstly. 
   */
  public Map<String, DataAccess.Variable<Object>> execSub(JZtScript.Subroutine statement, Map<String, DataAccess.Variable<Object>> args
      , boolean accessPrivate, Appendable out, File currdir) ////
  throws ScriptException //Throwable
  {
   ...
   * @throws IOException
   */
  public Map<String, DataAccess.Variable<Object>> execSub(JZtScript.Subroutine statement, List<DataAccess.Variable<Object>> arglist
  ...
  public final static class ExecuteLevel implements ScriptContext, FilePath.FilePathEnvAccess
  {
    ...
    /**Counts nesting of {@link #execute(org.vishia.cmd.JZtScript.StatementList, StringFormatter, int, boolean, Map, int)}
     * 1->0: leaf execution of this level, close {@link #cmdExecuter}    */
    int ctNesting = 0;
    
    final JZtThread threadData;
    
    
    final JZtScript.JZcmdClass jzClass;
     ...
     * It is used for the {@link #execCmdError(org.vishia.cmd.JZtScript.Onerror)}.
     */
     ...
     *   are to execute. 
     */
    protected ExecuteLevel(JZcmdMain acc, JZtScript.JZcmdClass jzClass, JZtThread threadData, ExecuteLevel parent
     ...
     */
    protected ExecuteLevel(JZcmdMain acc, JZtThread threadData)
    { this(acc, null, threadData, null, null);
    }
    
    
    /**Use the given CmdExecuter especially for a {@link JZtExecuter#execSub(org.vishia.cmd.JZtScript.Subroutine, List, boolean, Appendable, File)}
     * after {@link #levelForSubroutine(org.vishia.cmd.JZtScript.Subroutine)}.
    ...
    public JZtEngine scriptEngine(){ return jzcmdMain.jzcmdScript.getEngine(); }
     ...
     * (see @link {@link JZtScript.StatementList#bContainsVariableDef}) then this level is used,
     ...
     * @throws IOException
     */
    public short executeNewlevel(JZtScript.JZcmdClass jzClass, JZtScript.StatementList contentScript, final StringFormatter out, int indentOut
        , int nDebug) 
    throws Exception 
     ...
     * @param nDebugP
     * @return {@link JZtExecuter#kSuccess} ==0, {@link JZtExecuter#kBreak}, {@link JZtExecuter#kReturn} or {@link JZtExecuter#kException} 
     * @throws Exception
     */
    private short execute(JZtScript.StatementList statementList, StringFormatter out, int indentOutArg
    ...
    //throws Exception 
    {
      ...
      while(ret == 0 && ++ixStatement < statementList.statements.size()) { //iter.hasNext() && sError == null){
        JZtScript.JZcmditem statement = statementList.statements.get(ixStatement); //iter.next();
        ...
        try{    
          ...
          case '@': exec_SetColumn((JZtScript.TextColumn)statement, out);break; //<:@23>
          ...
          case 'T': ret = exec_TextAppendToVar((JZtScript.TextOut)statement, --nDebug1); break; //<+text>...<.+> 
          ...
          case 'U': ret = defineExpr(newVariables, (JZtScript.DefVariable)statement); break; //setStringVariable(statement); break; 
          case 'S': ret = defineExpr(newVariables, (JZtScript.DefVariable)statement); break; //setStringVariable(statement); break; 
          case 'P': { //create a new local variable as pipe
            StringBuilder uBufferVariable = new StringBuilder();
            exec_DefVariable(newVariables, (JZtScript.DefVariable)statement, 'P', uBufferVariable, true);
          } break;
          case 'L': ret = exec_DefList((JZtScript.DefContainerVariable)statement, newVariables); break; 
          case 'M': ret = exec_DefMapVariable((JZtScript.DefVariable)statement, newVariables); break;
          case 'W': ret = exec_Openfile(newVariables, (JZtScript.DefVariable)statement); break;
          case 'C': ret = exec_DefClassVariable((JZtScript.DefClassVariable) statement, newVariables); break; 
          case 'J': ret = exec_addClassLoader((JZtScript.DefClasspathVariable)statement, newVariables); break;
          case 'O': {
            Object value = evalObject(statement, false);
            if(value == JZtExecuter.retException){ ret = kException; }
            else {
              exec_DefVariable(newVariables, (JZtScript.DefVariable)statement, 'O', value, false);
            }
          } break;
          case 'K': {
            ...
            if(value == JZtExecuter.retException){ ret = kException; }
              ...
              exec_DefVariable(newVariables, (JZtScript.DefVariable)statement, 'K', value, false);
            }
          } break;
          case 'Q': {
            Object cond = new Boolean(evalCondition(statement));
            if(cond == JZtExecuter.retException){ ret = kException; }
            else {
              exec_DefVariable(newVariables, (JZtScript.DefVariable)statement, 'Q', cond, false);
            }
          } break;
          case '{': {  //a Subtext or codeblock variable:  
            ...
            exec_DefCodeblockVariable(newVariables, (JZtScript.Subroutine)statement, true); 
          } break;
          case 'e': ret = exec_Datatext((JZtScript.DataText)statement, out, indentOut, --nDebug1); break; 
          case 's': ret = exec_Call((JZtScript.CallStatement)statement, null, out, indentOut, --nDebug1); break;  //sub
          case 'x': ret = exec_Thread(newVariables, (JZtScript.ThreadBlock)statement); break;             //thread
          case 'm': exec_Move((JZtScript.FileOpArg)statement); break;             //move
          case 'y': exec_Copy((JZtScript.FileOpArg)statement); break;             //copy
          case 'l': exec_Delete((JZtScript.FileOpArg)statement); break;             //copy
          case 'c': exec_cmdline((JZtScript.CmdInvoke)statement); break;              //cmd
          case 'd': ret = exec_ChangeCurrDir(statement); break;                              //cd
          case '9': ret = exec_MkDir(statement); break;                              //mkdir
          case 'f': ret = exec_forContainer((JZtScript.ForStatement)statement, out, indentOut, --nDebug1); break;  //for
          case 'B': ret = exec_NestedLevel(statement, out, indentOut, --nDebug1); break;              //statementBlock
          case 'i': ret = exec_IfStatement((JZtScript.IfStatement)statement, out, indentOut, --nDebug1); break;
          case 'w': ret = exec_whileStatement((JZtScript.CondStatement)statement, out, indentOut, --nDebug1); break;
          case 'u': ret = exec_dowhileStatement((JZtScript.CondStatement)statement, out, indentOut, --nDebug1); break;
          case 'N': ret = exec_hasNext(statement, out, indentOut, --nDebug1); break;
          case '=': ret = assignStatement(statement); break;
          case '+': ret = appendExpr((JZtScript.AssignExpr)statement); break;        //+=
          case '?': break;  //don't execute a onerror, skip it.  //onerror
          case 'z': throw new JZtExecuter.ExitException(((JZtScript.ExitStatement)statement).exitValue);  
          case 'r': exec_Throw(statement); break;
          case 'v': exec_Throwonerror((JZtScript.Onerror)statement); break;
          case ',': bWriteErrorInOutput = statement.textArg !=null; break;
          case 'b': ret = JZtExecuter.kBreak; break;
          case '#': ret = exec_CmdError((JZtScript.Onerror)statement, out, indentOut); break;
          case 'F': ret = exec_createFilepath(newVariables, (JZtScript.DefVariable) statement); break;
          case 'G': ret = exec_createFileSet(newVariables, (JZtScript.UserFileset) statement); break;
          case 'o': ret = exec_OpenTextOut(statement, false); break;
          case 'q': ret = exec_OpenTextOut(statement, true); break;
          case 'Z': ret = exec_zmake((JZtScript.Zmake) statement, out, indentOut, --nDebug1); break;
        ...
        if(ret == kException){
          ...
          JZtScript.JZcmditem onerrorStatement = null;
          ...
          if(ixStatement < statementList.statements.size()){
            ...
            do { //search the appropriate error type:
              char onerrorType;
              JZtScript.Onerror errorStatement = (JZtScript.Onerror)onerrorStatement;
     ...
     * @throws IOException
     */
    void exec_Text(JZtScript.JZcmditem statement, Appendable out, int indentOut) throws IOException{
    ...
    void exec_SetColumn(JZtScript.TextColumn statement, StringFormatter out) throws Exception{
      int column = -1;
      int minChars = -1;
    ...
    /**
     * @param newVariables
     * @param statement {@link JZtScript.DefVariable#defVariable} contains the type.
     * @param type unused, see statement
     * @param value
     * @param isConst
     * @throws Exception
     */
    void exec_DefVariable(Map<String, DataAccess.Variable<Object>> newVariables, JZtScript.DefVariable statement, char type, Object value, boolean isConst) 
    throws Exception {
     ...
     * @throws Exception
     */
    void exec_DefCodeblockVariable(Map<String, DataAccess.Variable<Object>> newVariables, JZtScript.Subroutine statement, boolean isConst) 
    throws Exception {
    ...
    protected short exec_DefList(JZtScript.DefContainerVariable statement,  Map<String, DataAccess.Variable<Object>> newVariables)
    throws Exception   
    { short ret = 0;
      Object value;
      if(statement.statementlist !=null) {
        ...
        for(JZtScript.JZcmditem elementStm: statement.statementlist.statements) {
          ...
          } else if (elementStm instanceof JZtScript.Subroutine) {
            JZtScript.Subroutine stm1 = (JZtScript.Subroutine) elementStm;
          ...
          } else if (elementStm instanceof JZtScript.DefVariable) {
            //A variable:
            JZtScript.DefVariable stm1 = (JZtScript.DefVariable) elementStm;
      ...
      if(value == JZtExecuter.retException){ ret = kException; }
        ...
        if(value !=null && !(value instanceof Iterable<?>)) 
          throw new NoSuchFieldException("JZcmdExecuter - exec variable must be of type Iterable ;" + ((JZtScript.DefVariable)statement).defVariable);
        if(value ==null){ //initialize the list
          value = new ArrayList<Object>();
        }
        exec_DefVariable(newVariables, (JZtScript.DefVariable)statement, 'L', value, true);
      }
      return ret;
    }
    ...
    protected short exec_DefMapVariable(JZtScript.DefVariable statement,  Map<String, DataAccess.Variable<Object>> newVariables) 
    throws Exception   
    { short ret = kSuccess;
      Object value = evalObject(statement, false);
      if(value == JZtExecuter.retException) {
        ret = kException;
      } else {
        if(value == null) { //no initialization
          value = new TreeMap<String, DataAccess.Variable<?>>();
        }
        exec_DefVariable(newVariables, (JZtScript.DefVariable)statement, 'M', value, true); 
      }
      return ret;
    }
    ...
    protected short exec_DefClassVariable(JZtScript.DefClassVariable statement, Map<String, DataAccess.Variable<Object>> newVariables) 
    throws Exception   
    ...
    protected short exec_addClassLoader(JZtScript.DefClasspathVariable statement, Map<String, DataAccess.Variable<Object>> newVariables) 
    throws Exception {
      List<File> filesjar = new LinkedList<File>();
      for(JZtScript.AccessFilesetname fileset: statement.jarpaths){
        if(fileset.filesetVariableName !=null){  //fileset variable
          JZtAccessFileset zjars = new JZtAccessFileset(fileset, fileset.filesetVariableName, this);
          List<JZtFilepath> jars = zjars.listFilesExpanded();
          for(JZtFilepath jfilejar: jars){
          ...
          //}
          JZtFilepath jfilejar = new JZtFilepath(this, accessPath);
          File filejar = new File(jfilejar.absfile().toString());
          if(!filejar.exists()) throw new IllegalArgumentException("JZcmd.addClasspath - file does not exist; " + filejar.getAbsolutePath());
          filesjar.add(filejar);
        }
    ...
    short exec_createFilepath(Map<String, DataAccess.Variable<Object>> newVariables, JZtScript.DefVariable statement) throws Exception {
      CharSequence sPath = evalString(statement);
      if(sPath == JZtExecuter.retException){ return kException; }
      else {
      
        JZtFilepath filepath = new JZtFilepath(this, sPath.toString());
    ...
    short exec_createFileSet(Map<String, DataAccess.Variable<Object>> newVariables, JZtScript.UserFileset statement) throws Exception {
      JZtFileset filepath = new JZtFileset(this, statement);
      storeValue(statement.defVariable, newVariables, filepath, false);
      return kSuccess;
    }
    
      
    private short exec_forContainer(JZtScript.ForStatement statement, StringFormatter out, int indentOut, int nDebug) 
    throws Exception
    {
      JZtScript.StatementList subContent = statement.statementlist();  //The same sub content is used for all container elements.
     ...
     * @throws Exception
     */
    short exec_hasNext(JZtScript.JZcmditem statement, StringFormatter out, int indentOut, int nDebug) 
    throws Exception{
      short cont = kSuccess;
      if(this.bForHasNext){
        JZtScript.StatementList statementList = statement.statementlist();
     ...
     * @throws Exception 
     */
    short exec_IfStatement(JZtScript.IfStatement ifStatement, StringFormatter out, int indentOut, int nDebug) 
    throws Exception{
      short cont = kFalse;
      Iterator<JZtScript.JZcmditem> iter = ifStatement.statementlist.statements.iterator();
      //boolean found = false;  //if block found
      while(iter.hasNext() && cont == kFalse ){ //check which if branch should be executed
        JZtScript.JZcmditem statement = iter.next();
        switch(statement.elementType()){
          case 'g': { //if-block
            JZtScript.IfCondition ifBlock = (JZtScript.IfCondition)statement;
     ...
     * @throws Exception */
    short exec_whileStatement(JZtScript.CondStatement whileStatement, StringFormatter out, int indentOut, int nDebug) 
    throws Exception 
    {
      short cont = kSuccess;
      boolean cond;
     ...
     * @throws Exception */
    short exec_dowhileStatement(JZtScript.CondStatement whileStatement, StringFormatter out, int indentOut, int nDebug) 
    throws Exception 
    { short cont;
      boolean cond;
      do{
     ...
     * and executes {@link #execute(JZtScript.StatementList, StringFormatter, int, Map, int)}
     * with it. The arg 'indentOutArg' is set from the {@link JZtScript.JZcmditem#srcColumn} of the statement. 
     * @param statement the statement
     * @throws Exception 
     */
    short exec_TextAppendToOut(JZtScript.JZcmditem statement, StringFormatter out, int nDebug) throws Exception
    { short ret;
      if(statement.statementlist !=null){
        ...
        ret = text == JZtExecuter.retException ? kException : kSuccess;
        if(text !=null){
          synchronized(out){
            out.append(text);
          }
     ...
     * @throws Exception 
     */
    short exec_TextAppendToVar(JZtScript.TextOut statement, int nDebug) throws Exception
    ...
    private short exec_Call(JZtScript.CallStatement callStatement, List<DataAccess.Variable<Object>> additionalArgs
        , StringFormatter out, int indentOut, int nDebug) 
    throws IllegalArgumentException, Exception
    { short success = kSuccess;
      final CharSequence nameSubtext;
      JZtScript.Subroutine subroutine = null;
      /*
      ...
      if(callStatement.call_Name.dataAccess !=null) {
        ...
        if(o instanceof JZtScript.Subroutine) {
          subroutine = (JZtScript.Subroutine)o;  //eval codeblock
          nameSubtext = null;
          ...
          subroutine = null;  
          @SuppressWarnings("unchecked") 
          DataAccess.Variable<JZtScript.StatementList> var = (DataAccess.Variable<JZtScript.StatementList>)o;
          JZtScript.StatementList statements = var.value();
     ...
     * @throws ScriptException
     */
    public Object evalSubroutine(JZtScript.Subroutine substatement
     ...
     * The routine creates an own level to execute the sub routine unless the subroutine is marked with {@link JZtScript.Subroutine#useLocals}.
     * It calls {@link #levelForSubroutine(org.vishia.cmd.JZtScript.Subroutine)} therefore.
     * Internally the private {@link #exec_Subroutine(org.vishia.cmd.JZtScript.Subroutine, ExecuteLevel, List, List, StringFormatter, int, int)} is called.
     ...
     * @throws Exception
     */
    public short exec_Subroutine(JZtScript.Subroutine subroutine
        , Map<String, DataAccess.Variable<Object>> args
        , StringFormatter out, int indentOut
    )  
    {
     ...
     * If the subroutine designates {@link JZtScript.Subroutine#useLocals} then a new level is not created,
     * instead this is returned.
     * @param subroutine
     * @return
     */
    public final ExecuteLevel levelForSubroutine(JZtScript.Subroutine subroutine) {
      final ExecuteLevel sublevel;
      JZtScript.JZcmdClass subClass = (JZtScript.JZcmdClass)subroutine.parentList;
     ...
     * @throws Exception
     */
    private short exec_Subroutine(JZtScript.Subroutine statement
        , ExecuteLevel sublevel
        , List<JZtScript.Argument> actualArgs
    ...
    ) throws Exception
    {
      ...
      if(statement.formalArgs !=null){
        ...
        //
        TreeMap<String, JZtScript.DefVariable> check = new TreeMap<String, JZtScript.DefVariable>();
        for(JZtScript.DefVariable formalArg: statement.formalArgs) {
        ...
        //
        if(actualArgs !=null){
          for( JZtScript.Argument actualArg: actualArgs){  //process all actual arguments
            Object ref;
            ref = evalObject(actualArg, false);
            JZtScript.DefVariable checkArg = check.remove(actualArg.getIdent());      //is it a requested argument (per name)?
            if(checkArg == null){
        ...
        if(additionalArgs !=null){
          for(DataAccess.Variable<Object> arg: additionalArgs){
            ...
            JZtScript.DefVariable checkArg = check.remove(name);      //is it a requested argument (per name)?
            if(checkArg == null){
        ...
        for(Map.Entry<String, JZtScript.DefVariable> checkArg : check.entrySet()){
          JZtScript.DefVariable arg = checkArg.getValue();
          ...
          if(cType == 'F' && !(ref instanceof JZtFilepath) ){
            ref = new JZtFilepath(this, ref.toString());
          }
    ...
    /**Executes a Zmake subroutine call. Additional to {@link #exec_Call(org.vishia.cmd.JZtScript.CallStatement, List, StringFormatter, int, int)}
     ...
     * @throws Exception
     */
    private short exec_zmake(JZtScript.Zmake statement, StringFormatter out, int indentOut, int nDebug) 
    throws IllegalArgumentException, Exception {
      ...
      for(JZtScript.AccessFilesetname input: statement.input){
        JZtAccessFileset zinput = new JZtAccessFileset(input, input.filesetVariableName, this);
        if(target.inputs ==null){ target.inputs = new ArrayList<JZtAccessFileset>(); }
     ...
     * @throws Exception 
     */
    private short exec_Thread(Map<String, DataAccess.Variable<Object>> newVariables, JZtScript.ThreadBlock statement) 
    throws Exception
    { final JZtThread thread;
      final String name;
      if(statement.threadVariable !=null){
        try{
          thread = new JZtThread();
        ...
        thread = new JZtThread();  //without assignment to a variable.
        name = "JZcmd";
      }
     ...
     *   see return of {@link #execute(org.vishia.cmd.JZtScript.StatementList, Appendable, int, boolean)}
     *   A {@link JZtExecuter#kBreak} inside the statementlist is not returned. The break is only valid
     *   inside the block. All other return values of execute are returned.
     * @throws IOException
     */
    private short exec_NestedLevel(JZtScript.JZcmditem script, StringFormatter out, int indentOut, int nDebug) 
    throws Exception
    {
    ...
    private void exec_cmdline(JZtScript.CmdInvoke statement) 
    throws IllegalArgumentException, Exception
    {
      //boolean ok = true;
      ...
      if(statement.cmdArgs !=null){
        //int iArg = 1;
        for(JZtScript.JZcmditem arg: statement.cmdArgs){
      ...
      if(statement.variable !=null){
        ...
        if(statement.assignObjs !=null){
          for(JZtScript.JZcmdDataAccess assignObj1 : statement.assignObjs){
    ...
    short exec_CmdError(JZtScript.Onerror statement, StringFormatter out, int indentOut) throws Exception {
      short ret = 0;
    ...
    short exec_ChangeCurrDir(JZtScript.JZcmditem statement)
    throws Exception
    {
      /*if(statement.dataAccess !=null){
        ...
        if(arg == JZtExecuter.retException){ return kException; }
        else {
          changeCurrDir(arg); 
          return kSuccess;
        }
    ...
    short exec_MkDir(JZtScript.JZcmditem statement)
    throws Exception
    {
      CharSequence arg = evalString(statement);
      if(arg == JZtExecuter.retException){ return kException; }
     ...
     * @throws Exception
     */
    short exec_OpenTextOut(JZtScript.JZcmditem statement, boolean bAppend)
    throws Exception
    {
      CharSequence arg = evalString(statement);
      if(arg == JZtExecuter.retException){ return kException; }
     ...
     * @throws Exception
     */
    private short exec_Datatext(JZtScript.DataText statement, StringFormatter out, int indentOut, int nDebug)  //<*datatext>
    throws IllegalArgumentException, Exception
    { short success = kSuccess;
      ...
      if(text !=null) { //set already.
      } else if(obj == JZtExecuter.retException){ 
        success = kException; 
      }
      else {
        if(statement.format !=null){ //it is a format string:
          ...
          if(variable.type() == 'X') { 
            ...
            @SuppressWarnings("unchecked") 
            DataAccess.Variable<JZtScript.Subroutine> var = (DataAccess.Variable<JZtScript.Subroutine>)obj;
            JZtScript.Subroutine subroutine = var.value();
    ...
    void exec_Move(JZtScript.FileOpArg statement) 
    throws IllegalArgumentException, Exception
    {
    ...
    void exec_Copy(JZtScript.FileOpArg statement) 
    throws Exception
    { String ssrc, sdst;
      Object osrc = evalObject(statement.src, false);
      if(osrc instanceof JZtFilepath){
        ssrc = ((JZtFilepath)osrc).absfile().toString();
      } else {
        ssrc = osrc.toString();
      }
      Object odst = evalObject(statement.dst, false);
      if(odst instanceof JZtFilepath){
        sdst = ((JZtFilepath)odst).absfile().toString();
      } else {
        sdst = odst.toString();
      }
    ...
    void exec_Delete(JZtScript.FileOpArg statement) 
    throws Exception
    {
      CharSequence s1 = evalString(statement.src);
    ...
    /**Creates a new FileWriter with the given name {@link #evalString(org.vishia.cmd.JZtScript.Argument)}
     ...
     * @throws Exception
     */
    short exec_Openfile(Map<String, DataAccess.Variable<Object>> newVariables, JZtScript.DefVariable statement) 
    throws IllegalArgumentException, Exception
    {
      CharSequence sqFilename = evalString(statement);
      if(sqFilename == JZtExecuter.retException){ return kException; }
      else {
    ...
    private short assignStatement(JZtScript.JZcmditem statement) throws IllegalArgumentException, Exception{
      //Object val = evalObject(statement, false);
      return assignObj((JZtScript.AssignExpr)statement, null, true); //val); 
    }
     ...
     * @throws Exception
     */
    private short assignObj(JZtScript.AssignExpr statement, Object val, boolean bEval) 
    throws IllegalArgumentException, Exception
    {
      ...
      short ret = kSuccess;
      Boolean cond = null;
      JZtScript.JZcmdDataAccess assignObj1 = statement.variable;
      if(assignObj1 ==null){
        //no assignment, only an expression which is a procedure call:
        Object oRet = evalObject(statement, false);
        if(oRet == JZtExecuter.retException){ ret = kException; }
        else { ret = kSuccess; }
      }
      Iterator<JZtScript.JZcmdDataAccess> iter1 = statement.assignObjs == null ? null : statement.assignObjs.iterator();
      while(assignObj1 !=null) {
        ...
        if(dst instanceof DataAccess.Variable<?>){
          ...
          if(oVal == null){ 
            ...
            if(oVal == JZtExecuter.retException){ ret = kException; }
          }
          dstField.set(oVal);
     ...
     * @throws Exception
     */
    short defineExpr(Map<String, DataAccess.Variable<Object>> newVariables, JZtScript.DefVariable statement) 
    throws IllegalArgumentException, Exception
    {
      Object init = evalObject(statement, false);  //maybe null
      if(init == JZtExecuter.retException){
        return kException;
      } else {
        Object val;
     ...
     * @throws Exception
     */
    short appendExpr(JZtScript.AssignExpr statement) 
    throws IllegalArgumentException, Exception
    {
      short ret;
      Object val = evalObject(statement, false);
      if(val == JZtExecuter.retException){ ret = kException; }
      else { ret = kSuccess; }
      JZtScript.JZcmdDataAccess assignObj1 = statement.variable;
      Iterator<JZtScript.JZcmdDataAccess> iter1 = statement.assignObjs == null ? null : statement.assignObjs.iterator();
      while(assignObj1 !=null) {
    ...
    void exec_Throw(JZtScript.JZcmditem statement) throws Exception {
     ...
     */
    void exec_Throwonerror(JZtScript.Onerror statement) throws CmdErrorLevelException{
    ...
    /**Checks either the {@link JZtScript.Argument#dataAccess} or, if it is null,
     * the {@link JZtScript.Argument#expression}. Returns either the Object which is gotten
     ...
     * @throws Exception
     */
    public Object evalDatapathOrExpr(JZtScript.Argument arg) throws Exception{
    ...
    public CharSequence evalString(JZtScript.JZcmditem arg) 
    throws Exception 
    {
      if(arg.textArg !=null) return arg.textArg;
        ...
        if(ret == kException){ return JZtExecuter.retException; }
     ...
     * @throws Exception
     */
    Object dataAccess(JZtScript.JZcmdDataAccess dataAccess
    ...
    private void calculateArguments(DataAccess dataAccess) throws Exception {
      ...
      for(DataAccess.DatapathElement dataElement : dataAccess.datapath()){  //loop over all elements of the path with or without arguments.
        ...
        List<JZtScript.JZcmditem> fnArgsExpr = null;

        if(  dataElement instanceof JZtScript.JZcmdDatapathElementClass){
          JZtScript.JZcmdDatapathElementClass jzcmdDataElement = (JZtScript.JZcmdDatapathElementClass)dataElement;
        ...
        if(  dataElement instanceof JZtScript.JZcmdDatapathElement ){
          JZtScript.JZcmdDatapathElement jzcmdDataElement = (JZtScript.JZcmdDatapathElement)dataElement;
        ...
        if(fnArgsExpr !=null) {
          ...
          int iArgs = -1;
          for(JZtScript.JZcmditem expr: fnArgsExpr){
     ...
     * <ul>
     * <li>String from {@link JZtScript.JZcmditem#textArg}
     * <li>Object from {@link JZtScript.JZcmditem#dataAccess}
     * <li>String from {@link JZtScript.JZcmditem#statementlist} if not 'M'
     * <li>Map<String, Object> from statementlist if the arg.{@link JZtScript.JZcmditem#elementType} == 'M'.
     *   it is d 'dataStruct'. 
     * <li>Object from {@link JZtScript.JZcmditem#expression}.
     * <li>If the arg is instanceof {@link JZtScript.Argument} - an argument of a call subroutine, then
     *   <ul>
     *   <li>If the {@link JZtScript.Argument#filepath} is set, then that {@link FilePath} is transfered
     *     to a {@link JZtFilepath} and returned. 
     *     A {@link JZtFilepath} contains the reference to this execution level.
     *   <li>If the {@link JZtScript.Argument#accessFileset} is set, then that {@link JZtScript.AccessFilesetname}
     *     is transfered to an instance of {@link JZtAccessFileset} and that instance is returned.   
     * </ul>
     * @param arg
     * @return Object adequate the arg, maybe null
     * @throws Exception any Exception while evaluating.
     */
    public Object evalObject(JZtScript.JZcmditem arg, boolean bContainer) throws Exception{
      Object obj;
      short ret = 0;
      if(arg.textArg !=null) obj = arg.textArg;
        ...
        if(arg.elementType == 'M') {  
          ...
          obj = ret == kException ? JZtExecuter.retException: newVariables;
        } else {
          ...
          obj = ret == kException ? JZtExecuter.retException:  u.toString();
        }
      } else if(arg.expression !=null){
        CalculatorExpr.Value value = calculateExpression(arg.expression); //.calcDataAccess(localVariables);
        obj = value.objValue();
      ...
      if(obj !=null && ret != kException && arg.conversion !=0){
        switch(arg.conversion){
          ...
          case 'F': {
            String value = obj.toString();
            obj = new JZtFilepath(this, value);
          } break;
          case 'G': {
            assert(arg.subitem instanceof JZtScript.AccessFilesetname);
            JZtScript.AccessFilesetname arg1 = (JZtScript.AccessFilesetname) arg.subitem;
            obj = new JZtAccessFileset(arg1, arg1.filesetVariableName, this);
          } break;
    ...
    /**Gets the value of the given Argument. It is a {@link JZtScript.JZcmditem#expression}
     * @param arg
     * @return
     * @throws Exception
     */
    public CalculatorExpr.Value evalValue(JZtScript.JZcmditem arg, boolean bContainer) throws Exception{
      if(arg.textArg !=null){
        return null;  //TODO
      }
      else if(arg.dataAccess !=null){
    ...
    public boolean evalCondition(JZtScript.JZcmditem arg) throws Exception{
      boolean ret;
     ...
     * @return
     */
    JZtFilepath convert2FilePath(Object osrc)
    { JZtFilepath ret;
      if(osrc == null){
        ret = null;
      }
      else if(osrc instanceof JZtFilepath){
        ret = (JZtFilepath)osrc;
      } else {
        String src = osrc.toString();
        ret = new JZtFilepath(this, new FilePath(src));
      }
      return ret;
    }
    
    
    protected void runThread(ExecuteLevel executeLevel, JZtScript.ThreadBlock statement, JZtThread threadVar){
      try{
    ...
    protected void finishThread(JZtThread thread){
      synchronized(thread){
    ...
    int debug(JZtScript.JZcmditem statement) //throws Exception
    { try{ 
        CharSequence text = evalString(statement);
        if(text !=null ){
    ...
    void throwIllegalDstArgument(CharSequence text, DataAccess dst, JZtScript.JZcmditem statement)
    throws IllegalArgumentException
    {
    ...
    { Object oValue;
      ...
      if(varV == null){
        ...
        oValue = varV.value();
        if(oValue instanceof JZtFilepath){
          oValue = ((JZtFilepath)oValue).data;  //the FilePath instance.
        } 
      }
      return oValue;
    }
