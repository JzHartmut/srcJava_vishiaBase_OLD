...
public class CmdExecuter implements Closeable
{
   ...
   * <ul>
   * <li>2017-01-01 Hartmut new: now alternatively to the command process the {@link JzTcExecuter#execSub(org.vishia.cmd.JzTcScript.Subroutine, List, boolean, Appendable, File)}
  ...
  /**For {@link JzTcScript.Subroutine}. It is created on demand if necessity.
   * 
   */
  private JzTcExecuter jzcmdExecuter;
  ...
  public void initJZcmdExecuter(JzTcScript script, String sCurrdir, MainCmdLogging_ifc log) throws Throwable
  { if(jzcmdExecuter == null) {
      jzcmdExecuter = new JzTcExecuter(log);
    }
  ...
  public void addCmd( JzTcScript.Subroutine jzsub
  ...
  public static class CmdQueueEntry
  {
    ...
    public JzTcScript.Subroutine jzsub;
    List<DataAccess.Variable<Object>> args;
    public String input;
    Appendable out1;
